			...
			<div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
				<div class="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
					<h1 class="text-pretty text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">
						Grow Your Farm, Reach Your Community
					</h1>
					<p
						class="mt-8 text-pretty text-lg font-medium text-gray-500 sm:max-w-md sm:text-xl/8 lg:max-w-none"
					>
						Join Our Local Farmer Marketplace and Connect with a Network of Loyal, Local Customers.
					</p>
					<div class="mt-10 flex items-center gap-x-6">
						<a href="#email-signup" class="btn btn-primary">Learn More</a>
					</div>
				</div>
				<div
