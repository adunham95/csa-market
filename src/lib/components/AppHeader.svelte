...
<header class="bg-white shadow">
	<div class="mx-auto max-w-3xl px-2 sm:px-4 lg:max-w-full lg:divide-y lg:divide-gray-200 lg:px-8">
		<div class="relative flex h-16 justify-between">
			...
			<div class="hidden lg:relative lg:z-10 lg:ml-4 lg:flex lg:items-center">
				<a
					href="/my-stores"
					type="button"
					class="relative mr-1 shrink-0 rounded-full bg-white p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
				>
					...
					<div class="flex items-center px-5">
						...
						<div class="flex items-center">
							<a
								href="/my-stores"
								type="button"
								class="relative ml-auto mr-1 shrink-0 rounded-full bg-white p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
							>
								<span class="absolute -inset-1.5"></span>
